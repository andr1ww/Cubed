...
{	
	...
	public:
	 ...
	 namespace Offsets {
		     inline auto ff = *(uint64_t*)(__readgsqword(0x60) + 0x10);
        inline uint64_t Realloc = ff + 0x197ebdc;
    };
...
struct TGuardValue
    ...
    __movsb(PBYTE(Data) + (NumElements * int32(sizeof(ArrayElementType))), (const PBYTE)&Element, int32(sizeof(ArrayElementType)));
			NumElements++;
